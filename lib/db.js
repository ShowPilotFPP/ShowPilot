...
const configMigrations = [
  ...
  ['audio_sync_offset_ms', 'INTEGER DEFAULT 0'],    // viewer audio sync offset; positive = play LATER (audio was early), negative = play EARLIER (audio was late). Set per-show to compensate for FPP audio output latency vs the cache delivery path.
